...
/**
 * Utility class for calculating Grundfos Alpha3 CRC16 checksums.
 *
...
public class CRC16Calculator {
    ...
    private static final int[] LOOKUP_TABLE = { 0, 4129, 8258, 12387, 16516, 20645, 24774, 28903, 33032, 37161, 41290,
    ...
    /**
     * Validates the CRC16 checksum for the given data.
     *
